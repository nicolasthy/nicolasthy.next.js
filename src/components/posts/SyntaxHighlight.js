    ...
    return (
        <div css={containerStyles}>
            <div>
                ...
                <span css={languageLabelStyles(codeLanguage)}>
                    {codeLanguage}
                </span>
            </div>
            <SyntaxHighlighter
                ...
                lineProps={lineNumber => {
                    ...
                    if (highlights && highlights.includes(lineNumber)) {
                        style.backgroundColor =
                            languageHighlightColors[
                                codeLanguage.toLowerCase()
                            ].background;
                        style.borderLeft = `3px solid ${
                            languageHighlightColors[codeLanguage.toLowerCase()]
                                .border
                        }`;
                    }
                    return { style };
                ...
                css={css`
                    background: ${theme.posts
                        .syntaxHighlightBackground} !important;
